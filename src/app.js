App = {
    ...
    initWeb3: async () => {
      if (typeof web3 !== 'undefined') {
        ...
        console.log("init Web3 is working");
      } else {
      ...
      if (window.ethereum) {
        ...
        console.log("Modern dapp is working");
      }
      // Legacy dapp browsers...
        ...
        web3.eth.sendTransaction({/* ... */})
        console.log("Legacy dapp is used");
      }
      // Non-dapp browsers...
      else {
    ...
    setLoading: (boolean) => {
      ...
      if (boolean) {
        loader.show()
        content.hide()
        console.log("setLoading is working")
      } else {
        loader.hide()
        content.show()
      }
